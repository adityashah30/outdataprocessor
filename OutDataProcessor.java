...
public class OutDataProcessor {
    ...
    public OutDataProcessor() throws IOException {
        linePattern = Pattern.compile("([\t ]*)(([\"])|([0-3]{0,1}[0-9][/][0-9]{2}[/][0-9]{4}))(.*)");
        lastValues = new String[8];
        currValues = new String[8];
        out1 = new BufferedWriter(new FileWriter(new File("OutProcessed1.txt")));
    }

    public static void main(String[] args) throws FileNotFoundException, IOException {
        OutDataProcessor obj = new OutDataProcessor();
        obj.extractLine();
    }

    public void extractLine() throws FileNotFoundException, IOException {
        Scanner in = new Scanner(new BufferedReader(new FileReader(new File("OutNew.txt")))).useDelimiter("\n");
        int count = 0;
        while (in.hasNext()) {
